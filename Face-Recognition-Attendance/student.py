...
class Student:
    ...
    # This part is image labels setting start 
        ...
        cou_combo["values"]=("Select Course","Computer Application","Civil","Mechanical","Data Science","Electrical")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2019-23","2020-24","2021-25","2022-26","2021-23","2022-24")
