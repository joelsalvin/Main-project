...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\bg1.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\bg1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\det1.jpg")
        det_img_btn=det_img_btn.resize((180,180),Image.ANTIALIAS)
        self.det_img1=ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img,command=self.face_rec,image=self.det_img1,cursor="hand2",)
        det_b1.place(x=700,y=200,width=180,height=180)

        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=700,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\att.jpg")
        att_img_btn=att_img_btn.resize((180,180),Image.ANTIALIAS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,command=self.attendance_pannel,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=950,y=200,width=180,height=180)
        ...
        att_b1_1.place(x=950,y=380,width=180,height=45)

        #  # Help  Support  button 4
        # hlp_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\tra1.jpg")
        tra_img_btn=tra_img_btn.resize((180,180),Image.ANTIALIAS)
        self.tra_img1=ImageTk.PhotoImage(tra_img_btn)

        tra_b1 = Button(bg_img,command=self.train_pannels,image=self.tra_img1,cursor="hand2",)
        tra_b1.place(x=450,y=200,width=180,height=180)

        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        tra_b1_1.place(x=450,y=380,width=180,height=45)

        # Photo   button 6
        # pho_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\qr1.png")
        ...
        # # exit   button 8
        exi_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\exi.jpg")
