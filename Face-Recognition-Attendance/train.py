...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\train.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\MainPrjt\Face-Recognition-Attendance\Images_GUI\t_btn1.png")
        std_img_btn=std_img_btn.resize((180,180),Image.ANTIALIAS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.train_classifier,image=self.std_img1,cursor="hand2")
        std_b1.place(x=700,y=180,width=180,height=180)
        ...
        std_b1_1.place(x=700,y=360,width=180,height=45)
